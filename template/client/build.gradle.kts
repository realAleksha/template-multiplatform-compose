...
kotlin {
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation(projects.shared.data.encoding)
            implementation(projects.shared.data.analytics)
            implementation(projects.shared.data.cache)
            implementation(projects.shared.data.config)
            implementation(projects.shared.data.expression)
            implementation(projects.shared.data.expressionImpl)
            implementation(projects.shared.data.encryption)
            implementation(projects.shared.data.encryptionKorlibs)
            implementation(projects.shared.data.paging)
            implementation(projects.shared.data.pagingJetpack)
            implementation(projects.shared.data.settings)
            implementation(projects.shared.data.settingsDatastore)
